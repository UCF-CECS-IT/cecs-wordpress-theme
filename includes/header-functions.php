 ...
 * 
 * CECS THEME MODIFIED - set a variety of custom header types
 */
 ...
 * 
 * CECS THEME MODIFIED - set a variety of custom content types
 */
if ( ! function_exists( 'ucfwp_get_header_content_type' ) ) {
	function ucfwp_get_header_content_type( $obj ) {
		...
		if ($header_type == 'fallback') {
			$content_type = 'title_subtitle';
		}
		/**
		 * End custom content types
		 */
