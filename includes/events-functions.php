...
/**
 * Pulls events from the UCF Events plugin url to feed into a custom-styled
 * sidebar.
 *
 * @param integer $limit
 * @return array
 */
function cecs_get_events( $limit = 5 ) {

	$events = ucfwp_fetch_json( get_option( 'ucf_events_feed_url' ) );
